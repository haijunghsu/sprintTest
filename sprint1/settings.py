...
SECRET_KEY = 'sk_test_WQFeIPjwmv6uzyBvwmfdq4GL00ktNTB984'
PUBLIC_KEY = 'pk_test_kBGIrn6ltFl45eOmqMQGrBzW00OtTqJb2y'
...
#newly added code to allow account model use to be authenticated
